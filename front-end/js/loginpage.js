...
import { getMultiFactorResolver } from "https://www.gstatic.com/firebasejs/9.6.10/firebase-auth.js";
...
document.getElementById('login-form').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    if (user.multiFactor?.enrolledFactors?.length > 0) {
      alert('Multi-factor authentication is required. Please complete MFA.');
    } else {
...
// Ensure animations are triggered appropriately
...
// Initialize arm positions for animations
